...
Types are the core building blocks of a Darig schema. A type defines a set of **properties** that an object must have.
...
## Validator Reference

Darig provides a comprehensive suite of validators to ensure your data meets specific constraints. These validators can be applied to properties in your schema definition.
