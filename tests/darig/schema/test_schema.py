...
file_path: "./features/darig/schema/data/thing.yaml"
directory_path: "./features/darig/schema/data/"
...
def test_dir_inputs_bad():
    yasl_path = "./features/darig/schema/data/bad_dir_test"
    yaml_path = "./features/darig/schema/data/bad_dir_test"
    # cwd = os.getcwd()
    # os.chdir(str((Path(__file__).parent.parent.parent / "features").resolve()))
    run_eval_command_with_paths(
...
def test_default_namespace():
    yasl_path = "./features/darig/schema/data/ambiguous_ns/todo01.yasl"
    yaml_path = "./features/darig/schema/data/ambiguous_ns/todo.yaml"
    run_eval_command_with_paths(
